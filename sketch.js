...
//variables que almacenan los sonidos 
...
function preload(){
  ...
  // para cada situacion que tenga el juego
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    //3°agregar la condicion para reproducir un sonido de cada 100 points
    ...
    if(keyDown("space")&& trex.y >= 100) {
        trex.velocityY = -12;
        //1° agregar el sonido de salto cada vez que el trex salte
        jumpSound.play();
    }
    ...
    if(obstaclesGroup.isTouching(trex)){
        gameState = END;
        //2° agregar el sonidos de muerto, cuando el trex choca contra un obstaculo
        dieSound.play();
    }
  }
